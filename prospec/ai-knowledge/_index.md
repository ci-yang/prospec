...
| **templates** | handlebars, hbs, init, change, skills, agent-configs, capability-spec, proposal-format, INVEST | Active | Handlebars template files for all generated artifacts, including INVEST proposal format and living capability spec format | readme, api-surface, dependencies, patterns | — |
